...
data_xgboost_validate_path = config.data.path('model-xgboost-validate.csv')
data_xgboost_submit_path = config.data.path('model-xgboost-submit.csv')
...
val.to_csv(data_xgboost_validate_path, float_format='%.6f', index=False)

# Create submission file
sub = pd.DataFrame()
sub['id'] = id_test
sub['target'] = y_test_pred
sub.to_csv(data_xgboost_submit_path, float_format='%.6f', index=False)
